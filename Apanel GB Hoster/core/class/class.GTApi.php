...
function ServerInfoV2($ip) {
	...
	$Return['country_flag'] = 'https://static.gametracker.rs/flags/'.$data['iso2'].'.png';
	$Return['best_rank'] = $data['rank_min'];
	$Return['worst_rank'] = $data['rank_max'];
	$Return['map'] = $data['map'];
	$Return['game_icon'] = 'https://static.gametracker.rs/images/game-'.$data['gameshort'].'.png';
	$Return['last_map'] = $data['lastMap'];
	$Return['map_image'] = 'https://banners.gametracker.rs/map/'.$data['gameshort'].'/'.$data['map'].'.jpg';
	$Return['day_graph'] = 'https://banners.gametracker.rs/'.$ip.'/graph-day/graph-day.jpg';
	$Return['week_graph'] = 'https://banners.gametracker.rs/'.$ip.'/graph-week/graph-week.jpg';
	$Return['month_graph'] = 'https://banners.gametracker.rs/'.$ip.'/graph-month/graph-month.jpg';
	$Return['rank_graph'] = 'https://banners.gametracker.rs/'.$ip.'/graph-rank/graph-rank.jpg';
	$data_day = explode(":", $data['players_day']);
	$average_day = array_sum($data_day)/count($data_day);
