...
function smile($smile) {
    ...
    $s_zamene = array (
		':)'		=>	'<img src="/images/icons/smile/001.png"  class="smile-img-icon">',
		':D'		=>	'<img src="/images/icons/smile/002.png"  class="smile-img-icon">',
		';)'		=>	'<img src="/images/icons/smile/003.gif"  class="smile-img-icon">',
		':O'		=>	'<img src="/images/icons/smile/004.png"  class="smile-img-icon">',
		':m'		=>	'<img src="/images/icons/smile/006.png"  class="smile-img-icon">',
		':/'		=>	'<img src="/images/icons/smile/007.png"  class="smile-img-icon">',
		':$'		=>	'<img src="/images/icons/smile/008.png"  class="smile-img-icon">',
		':S'		=>	'<img src="/images/icons/smile/009.png"  class="smile-img-icon">',
		':('		=>	'<img src="/images/icons/smile/010.png"  class="smile-img-icon">',
		';('		=>	'<img src="/images/icons/smile/011.gif"  class="smile-img-icon">',
		'o.o'		=>	'<img src="/images/icons/smile/012.png"  class="smile-img-icon">',
		':_3'		=>	'<img src="/images/icons/smile/015.png"  class="smile-img-icon">',
		':_/3'		=>	'<img src="/images/icons/smile/016.png"  class="smile-img-icon">',
		'-.-'		=>	'<img src="/images/icons/smile/083.png"  class="smile-img-icon">',
		':n'		=>	'<img src="/images/icons/smile/086.png"  class="smile-img-icon">',
		':P'		=>	'<img src="/images/icons/smile/104.png"  class="smile-img-icon">',
		':T'		=>	'<img src="/images/icons/smile/tuga.gif" class="smile-img-icon">',
		'xD'		=>	'<img src="/images/icons/smile/xD.png"   class="smile-img-icon">',
		'.!.'		=>	'<img src="/images/icons/smile/kk.png"   class="smile-img-icon">',
		'picka'		=>	'**cka',
		'kurac'		=>	'**rac',
		'svinja'	=>	'**inja',
		'stoka'		=>	'**oka',
