...
?>
		<div class="span4">
      		<div class="widget stacked">
				<a style="width: 86%;" href="javascript:;" class="btn btn-large btn-support-ask">Status: <?php if($server['igra'] == "7") echo formatStatus(getStatus($boxip['ip'], $box['sshport'])); else echo $online;?></a><br /><br />
