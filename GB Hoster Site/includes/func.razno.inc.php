...
function novac_2($novac, $drzava)
{
	$clientcurrency = mysql_fetch_array(mysql_query("SELECT * FROM `billing_currency` WHERE `zemlja`='{$drzava}'"));
	if($drzava=="srb"){
		$novacc = $novac * $clientcurrency['multiply_2'];
		return $novacc;	
	}else if($drzava=="hr"){
		$novacc = $novac * $clientcurrency['multiply_2'];	
		return $novacc;		
...
function drzavaimg($d)
{
	...
	if($d == "srb") $drzava = "<img src='./assets/$style/img/din.png' /> Srbija";
	else if($d == "hr") $drzava = "<img src='./assets/$style/img/kn.png' /> Hrvatska";
	else if($d == "bih") $drzava = "<img src='./assets/$style/img/km.png' /> Bosna i Hercegovina";
	else if($d == "mk") $drzava = "<img src='./assets/$style/img/den.png' /> Makedonija";
	else if($d == "cg") $drzava = "<img src='./assets/$style/img/e.png' /> Crna gora";
	else if($d == "other") $drzava = "<img src='./assets/$style/img/e.png' /> No Balkan";
	return $drzava;
}

function drzavavalutaimg($d)
{
	$style = $_SESSION['style'];
	if($d == "srb") $drzava = "<img src='https://gb-hoster.me/assets/$style/img/din.png' />";
	else if($d == "hr") $drzava = "<img src='https://gb-hoster.me/assets/$style/img/kn.png' />";
	else if($d == "bih") $drzava = "<img src='https://gb-hoster.me/assets/$style/img/km.png' />";
	else if($d == "mk") $drzava = "<img src='https://gb-hoster.me/assets/$style/img/den.png' />";
	else if($d == "cg") $drzava = "<img src='https://gb-hoster.me/assets/$style/img/e.png' />";
	else if($d == "other") $drzava = "<img src='https://gb-hoster.me/assets/$style/img/e.png' />";
	return $drzava;
}
...
{
	if($d == "srb") $drzava = "RSD";
	else if($d == "hr") $drzava = "HRK";
	else if($d == "bih") $drzava = "KM";
	else if($d == "mk") $drzava = "MKD";
	else if($d == "cg") $drzava = "€";
	else if($d == "other") $drzava = "€";
	return $drzava;
}
...
function igra($i)
{
	...
	else if($i == "6") $igra = "<img width='16' height='16' src='./assets/img/game-ts3.png' /> Team Speak 3";
	else if($i == "7") $igra = "<img width='16' height='16' src='./assets/img/game-fdl.png' /> FastDL";
	else if($i == "8") $igra = "<img width='16' height='16' src='./assets/img/game-sinusbot.png' /> Sinus Bot";
	return $igra;
}

function lokacija_ded($i)
{
	if($i == "1") $lok = "Lite - Nemaèka";
	else if($i == "2") $lok = "Premium - Bugarska";
	return $lok;
}
...
function ipadresabezporta($srvid)
{
	$port = query_fetch_assoc("SELECT `port`, `ip_id`, `box_id` FROM `serveri` WHERE `id` = '".$srvid."'");
	$ip = query_fetch_assoc("SELECT `ip` FROM `boxip` WHERE `ipid` = '".$port['ip_id']."'");
