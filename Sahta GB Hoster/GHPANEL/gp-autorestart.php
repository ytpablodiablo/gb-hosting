	            ...
	            <div id="server_info_infor">
	                <div id="server_info_infor2">
		                ...
		                <?php if (gp_game_id($Server_ID) == 1) { ?>
		                    ...
		                    <li class="nav_s_active"><a href="gp-autorestart.php?id=<?php echo $Server_ID; ?>">Autorestart</a></li>
		                    ...
		                    <div id="ftp_header">
		                        <div id="left_header">
		                            ...
		                            <div style="margin-top:15px;color: #fff;">
		                                ...
		                                <br/>Da vidite cemu sluzi ova funkcija posetite <a href=""><b>(Kako namjestiti Autorestart)</b></a>.</p>
		                            </div>
		                        </div>
		                    </div>              
		                    <div id="plugin_body">
