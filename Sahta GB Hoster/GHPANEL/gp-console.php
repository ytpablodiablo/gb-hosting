	            ...
	            <div id="server_info_infor">
	                <div id="server_info_infor2">
		                ...
		                <?php if (gp_game_id($Server_ID) == 1) { ?>
		                    ...
		                    <li class="nav_s_active"><a href="gp-console.php?id=<?php echo $Server_ID; ?>">Konzola</a></li>
		                ...
		                <?php } ?>
	                 	...
	                 	<div id="ftp_container">
		                    <div id="ftp_header">
		                        <div id="left_header">
		                            <div>
		                                <img src="/assets/img/icon/gp/gp-konzola.png">
		                            </div> 
		                            <div style="margin-top:15px;color: #fff;">
		                                <strong>Konzola</strong>
		                                Ovde mozete slati komande koje ce biti izvrsene na serveru.
                            			<br />Konzola se refresuje automatcki svakih 5sec.
		                            </div>
		                        </div>
		                    </div>              
...
<?php
    if(!($con = ssh2_connect(server_ip($Server_ID), box_ssh(getBOX($Server_ID))))) { 
        ...
        if(!ssh2_auth_password($con, server_username($Server_ID), server_password($Server_ID))) {
            return "error";
        } else {
