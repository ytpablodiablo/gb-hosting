...
if ((file_exists($cache_path)) && ($mtime < 300)) { 
	...
	/*$s_info = mysql_fetch_array(mysql_query("SELECT * FROM `serveri` WHERE `id` = '$Server_ID'"));

	$players = '11';

	if(empty($s_info['graph'])) {
		$kolona5min = "0";
	} else {
		$kolona5min = $s_info['graph'];
	}
	...
	mysql_query("UPDATE `serveri` SET `graph` = '$igraci' WHERE `id` = '$Server_ID'");*/

	// Cache

	$playersmax = server_slot($Server_ID);

	// full_day = 32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32:32
