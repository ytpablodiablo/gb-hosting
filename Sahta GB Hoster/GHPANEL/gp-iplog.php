	                        ...
	                        <div id="serveri">
	                            <table>
	                                <tbody>
	                                    ...
	                                    <?php
	                                        error_reporting(0);  
	                                        $numberOfElements = mysql_num_rows(mysql_query("SELECT * FROM logovi WHERE clientid='{$_SESSION['user_login']}'"));
	                                        ...
	                                        $data_query = mysql_query("SELECT * FROM logovi WHERE clientid='{$_SESSION['user_login']}' LIMIT {$start}, {$limit}");
