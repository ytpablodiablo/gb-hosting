	                       	...
	                       	<div class="tiket-content">
                                <div class="tiket_info_home">
                                    ...
                                    <div class="tiket_info_home_a">
                                        <li>
                                        	<img alt="" src="/assets/img/2.jpg" class="media-object thumb-sm img-circle" style="width:45px;height:45px;">
                                        </li>
                                        <li>
                                        	<p><strong><?php echo user_full_name($_SESSION['user_login']); ?></strong></p>
                                        	<span><i>Korisnik</i></span>
                                        </li>
                                    </div>
                                    
                                    <div class="tiket_info_home_c_o">
                                        <form action="/process.php?a=add_newtiket" method="POST" autocomplete="off">
                                            <input type="text" name="ticket_name" placeholder="Naslov" required="">
                                            <br />

                                            <select name="server_id" id="server_id">
                                            	<option value="0">Svi serveri</option>
	                                            <?php  
	                                            $s_list = mysql_query("SELECT * FROM `serveri` WHERE `user_id` = '$_SESSION[user_login]'");
	                                            while($row = mysql_fetch_array($s_list)) { ?>
                                            ...
                                            <textarea name="ticket_txt" class="odgovor" placeholder="Napisite vas problem..."></textarea>
                                            <button class="right"><i class="glyphicon glyphicon-ok"></i> POSALJI</button>
                                        </form>
                                    </div>
