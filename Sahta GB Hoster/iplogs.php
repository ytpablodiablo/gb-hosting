...
<html>
	<head>
		<title><?php echo site_settings($conn, "site_name"); ?> | <?php echo $lang['IpLogs']; ?></title>
	...
	<body>
		...
		<div class="container">
			<div class="rows">
				<div class="contect">
					<h2><i class="fa fa-file-text"></i> <?php echo $lang['IPLOGOVI']; ?></h2>
					...
					?>
								<tr>
									...
									<td><?php echo $row['datum']; ?>, pre <?php echo $vreme; ?></td>
								</tr>
    						<?php endwhile; ?>
    						</tbody>
    					</table>
